...
class _$_Authenticated with DiagnosticableTreeMixin implements _Authenticated {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Auth.authenticated'))
...
class _$_Unauthenticated
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'Auth.unauthenticated'));
  }
...
class _$_Loading with DiagnosticableTreeMixin implements _Loading {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'Auth.loading'));
  }
